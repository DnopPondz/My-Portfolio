  ...
  return (
    <div className="navbar bg-[#2a0945] sticky top-0 ">
      <div className="navbar-start ">
        ...
        <Link href="/" className="btn btn-ghost text-3xl text-white">
          Wachirodol <span className="text-[#fcda68]">Portfolio</span>
        </Link>
      </div>
      ...
      <div className="navbar-end ">
        ...
        >
          <i
            className={`bx transition-transform duration-500 ${
              isDarkMode ? "bxs-sun opacity-100" : "bxs-moon opacity-100"
            }`}
            style={{
